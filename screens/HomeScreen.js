...
const face = require("../icons/Ui/face.png");
const magnifyingGlass = require("../icons/Ui/magnifying-glass.png");
const menu = require("../icons/Ui/menu.png");
const vehicle1 = require("../icons/vehicles/v-1.png");
const vehicle2 = require("../icons/vehicles/v-2.png");
const vehicle3 = require("../icons/vehicles/v-3.png");
const vehicle4 = require("../icons/vehicles/v-4.png");
...
const getImage = (id) => {
  if(id == 1) return vehicle1;
  if(id == 2) return vehicle2;
  if(id == 3) return vehicle3;
  if(id == 4) return vehicle4;
}
